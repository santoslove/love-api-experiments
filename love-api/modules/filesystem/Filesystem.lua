    ...
    functions = {
        ...
        },
        {
            ...
            descriptiont = {
                ...
                fr = 'Obtient le chemin d\'accès complet au fichier ou au répertoire .love. Si le jeu est fusionné à l\'exécutable LÉ-VE, l\'exécutable est renvoyé. [auto]',
